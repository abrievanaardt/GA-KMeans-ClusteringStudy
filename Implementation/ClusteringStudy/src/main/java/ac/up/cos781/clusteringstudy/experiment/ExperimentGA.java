...
//
//public class ExperimentGA extends Thread {
//
//    /**
//     *
//     * @param _numSim
...
//     * @param _numK
//     */
//    public ExperimentGA(int _numSim, int _maxEpoch, int _numK) {
...
//                     * Calculates the running average assuming indexing starts
//                     * at 1
//                     *
//                     * @param oldAvg
//                     * @param newValue
...
//
//    + EXT);
//    dataset.setDatasetName (datasetNames 
//    [i]);
//
